...
const ShutlIntro = () => {
  ...
  return (
    <div className="ShutlIntro-intro-container">
      {currentIntro === 1 && (
        <>
          <img src="intro1.png" alt="Intro 1" className="ShutlIntro-intro-image" />
      ...
      {currentIntro === 2 && (
        <div className="ShutlIntro-intro-content">
          <img src="intro2.png" alt="Intro 2" className="ShutlIntro-intro-image" />
      ...
      {currentIntro === 3 && (
        <div className="ShutlIntro-intro-content">
          <img src="intro3.png" alt="Intro 3" className="ShutlIntro-intro-image" />
          <p><b>Finance</b></p>
      ...
      <div className="ShutlIntro-pagination-dots">
        <span className={`ShutlIntro-dot ${currentIntro === 1 ? 'active' : ''}`} onClick={() => setCurrentIntro(1)} />
        <span className={`ShutlIntro-dot ${currentIntro === 2 ? 'active' : ''}`} onClick={() => setCurrentIntro(2)} />
        <span className={`ShutlIntro-dot ${currentIntro === 3 ? 'active' : ''}`} onClick={() => setCurrentIntro(3)} />
      </div>
