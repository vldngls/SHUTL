  ...
  return (
    <div className="TellerSummary-modal" onClick={handleOverlayClick}>
      <div className="TellerSummary-container">
        <button onClick={onClose} className="TellerSummary-close-btn">Close</button>

        <div className="TellerSummary-section">
  <h3>Summary</h3>
  <p>Today</p>
  <div className="TellerSummary-stats">
    <div><strong>43</strong><br />Round Trips</div>
    <div><strong>578</strong><br />Passengers</div>
    <div><strong>3</strong><br />Shuttles</div>
    <div><strong>126</strong><br />Pick-up</div>
  </div>
</div>
        ...
        <div className="TellerSummary-section">
          ...
          <div className="TellerSummary-chart">[Passenger Chart]</div> {/* Placeholder for a chart */}
        </div>
        ...
        <div className="TellerSummary-section">
          ...
          <div className="TellerSummary-route">
            <div>
              ...
              <p>1 hr 16 min route<br />32 min departure</p>
            </div>
            <div>
        ...
        <div className="TellerSummary-section">
          ...
          <div className="TellerSummary-fare">
            <p><strong>16,880</strong> Net Earning</p>
            <p><strong>463</strong> Regular</p>
            <p><strong>115</strong> Discounted</p>
            <p><strong>578</strong> Pick-up</p>
          </div>
